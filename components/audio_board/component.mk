...
ifdef CONFIG_ESP_AI_THINKER_AUDIO_KIT_REV_A_BOARD || CONFIG_ESP_AI_THINKER_AUDIO_KIT_REV_B_BOARD
COMPONENT_ADD_INCLUDEDIRS += ./ai_thinker_audio_kit
COMPONENT_SRCDIRS += ./ai_thinker_audio_kit
endif
